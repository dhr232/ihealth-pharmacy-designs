...
const ASSURANCES = [
  {
    ...
    title: "Top Rated in Chilliwack",
    description: "100% 5-star community care trusted by local families and seniors across the Fraser Valley.",
  ...
  },
  {
    ...
    title: "All Major Plans Accepted",
    description: "100% direct coverage for BC Fair PharmaCare, Blue Cross, Sun Life, Manulife, and NIHB.",
    href: "/about#billing",
    external: false,
  },
];
