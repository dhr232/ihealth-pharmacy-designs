  ...
  return (
    ...
    >
      <div className={`relative w-full h-full ${flipX ? "-scale-x-100" : ""}`}>
        {/* Tier 1: Deep Parallax Ribbon (Tailwind text-slate-300/60, slowest 32s) */}
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          <motion.svg
            viewBox="0 0 2880 90"
            fill="currentColor"
            preserveAspectRatio="none"
            className="w-[200%] max-w-none h-full block text-slate-300/60"
        ...
        {/* Tier 2: Mid-Ground Parallax Ribbon (Tailwind text-slate-200/85, 24s) */}
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          <motion.svg
            viewBox="0 0 2880 90"
            fill="currentColor"
            preserveAspectRatio="none"
            className="w-[200%] max-w-none h-full block text-slate-200/85"
            style={{ willChange: "transform" }}
            animate={
              shouldReduceMotion
                ? undefined
        ...
        {/* Tier 3: Foreground Solid Transition Wave with Architectural 3D Shelf Shadow */}
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          <motion.svg
            viewBox="0 0 2880 90"
            fill="currentColor"
            preserveAspectRatio="none"
            className={`w-[200%] max-w-none h-full block ${fillColor} drop-shadow-[0_-8px_16px_rgba(0,0,0,0.12)]`}
            style={{ willChange: "transform" }}
            animate={
              shouldReduceMotion
                ? undefined
