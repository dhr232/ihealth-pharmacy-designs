        ...
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li>
                <Link href="/services/minor-ailments" className="text-white/80 transition hover:text-white">Minor Ailments</Link>
              </li>
              <li>
                <Link href="/services/compounding" className="text-white/80 transition hover:text-white">Compounding</Link>
              </li>
              <li>
                <Link href="/services/myhealthpack" className="text-white/80 transition hover:text-white">MyHealthPack</Link>
              </li>
              <li>
                <Link href="/services/vaccinations" className="text-white/80 transition hover:text-white">Vaccinations</Link>
              </li>
            </ul>
          </div>
        </div>
